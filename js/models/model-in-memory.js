...
directory.MemoryStore = function (successCallback, errorCallback) {
    ...
    this.employees = [
        ...
        {"id": 2, "firstName": "Ingenu", "lastName": "RPMA", "managerId": 1, managerName: "James King", "title": "Ingenu LPWAN Technology - RPMA", "department": "", "cellPhone": "", "officePhone": "", "email": "", "city": "", "pic": "ingenu_rpma.jpg", "twitterId": "", "blog": "","copyright":"gnu", "type":"Communication","url":"contact us"}        
    ];
